    ...
    <div class="container-fluid d-flex justify-content-between align-items-center p-0 m-0">
        <div class="d-flex gap-4 align-items-center">
            <a data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
                <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><rect width="24" height="24" fill="none"/><path fill="currentColor" d="M3 8h18a1 1 0 0 0 0-2H3a1 1 0 0 0 0 2m18 8H3a1 1 0 0 0 0 2h18a1 1 0 0 0 0-2m0-5H3a1 1 0 0 0 0 2h18a1 1 0 0 0 0-2"/></svg>
            </a>
        ...
        <div class="d-flex justify-content-between align-items-center gap-4">
            <div class="btn-group">
                <button type="button" class="" data-bs-toggle="dropdown" aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 32 32"><rect width="32" height="32" fill="none"/><path fill="currentColor" d="M28.707 19.293L26 16.586V13a10.014 10.014 0 0 0-9-9.95V1h-2v2.05A10.014 10.014 0 0 0 6 13v3.586l-2.707 2.707A1 1 0 0 0 3 20v3a1 1 0 0 0 1 1h7v.777a5.152 5.152 0 0 0 4.5 5.199A5.006 5.006 0 0 0 21 25v-1h7a1 1 0 0 0 1-1v-3a1 1 0 0 0-.293-.707M19 25a3 3 0 0 1-6 0v-1h6Zm8-3H5v-1.586l2.707-2.707A1 1 0 0 0 8 17v-4a8 8 0 0 1 16 0v4a1 1 0 0 0 .293.707L27 20.414Z"/></svg>               
                </button>
  ...
  <div class="offcanvas-body">
    <div class="dash-container row p-3 m-0">
      <div class="col-12 p-0 m-0">
        <a href="{{ route('dashboard') }}" class="side-dash-icon d-flex align-items-center gap-2">
    ...
    <div class="book-icon-container row p-3 m-0">
      <div class="col-12 p-0 m-0">
        <a href="{{ route('bookmanagement') }}" class="book-icon d-flex align-items-center gap-2">
    ...
    <div class="inventory-icon-container row p-3 m-0">
        <div class="col-12 p-0 m-0">
            <a href="{{ route('bookinventory') }}" class="inventory-icon d-flex align-items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24"><rect width="24" height="24" fill="none"/><path fill="currentColor" d="m21 11.5l1.5 1.5l-6.99 7L11 15.5l1.5-1.5l3.01 3z"/><path fill="currentColor" d="M17 5v3H7V5H5v14h6.68l-3.51-3.5l4.33-4.33l3.01 3l3.49-3.5V5z" opacity="0.3"/><path fill="currentColor" d="M5 19V5h2v3h10V5h2v5.67l2-2V5c0-1.1-.9-2-2-2h-4.18C14.4 1.84 13.3 1 12 1s-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8.68l-2-2zm7-16c.55 0 1 .45 1 1s-.45 1-1 1s-1-.45-1-1s.45-1 1-1"/></svg>
                <span>Inventory</span>
            </a>
        </div>
    </div>
    <div class="account-icon-container row p-3 m-0">
        <div class="col-12 p-0 m-0">
            <a href="{{ route('accountmanagement') }}" class="account-icon d-flex align-items-center gap-2">
    ...
    <div class="user-icon-container row p-3 m-0">
        <div class="col-12 p-0 m-0">
            <a href="{{ route('usermanagement') }}" class="user-icon d-flex align-items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24"><rect width="24" height="24" fill="none"/><path fill="currentColor" d="M7.5 6.5C7.5 8.981 9.519 11 12 11s4.5-2.019 4.5-4.5S14.481 2 12 2S7.5 4.019 7.5 6.5M20 21h1v-1c0-3.859-3.141-7-7-7h-4c-3.86 0-7 3.141-7 7v1z"/></svg>
                <span>User Management  </span>
            </a>
        </div>
    </div>
    <div class="transaction-icon-container row p-3 m-0">
        <div class="col-12 p-0 m-0">
            <a href="{{ route('Reservation') }}" class="transaction-icon d-flex align-items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><rect width="24" height="24" fill="none"/><path fill="none" stroke="currentColor" stroke-width="2" d="M2 7h18m-4-5l5 5l-5 5m6 5H4m4-5l-5 5l5 5"/></svg>
    ...
    <div class="transaction-icon-container row p-3 m-0">
        <div class="col-12 p-0 m-0">
            <a href="{{ route('transaction') }}" class="transaction-icon d-flex align-items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><rect width="24" height="24" fill="none"/><path fill="none" stroke="currentColor" stroke-width="2" d="M2 7h18m-4-5l5 5l-5 5m6 5H4m4-5l-5 5l5 5"/></svg>
        ...
        <div class="mb-0">
            <div class="transaction-icon-container row p-3 m-0">
                <div class="col-12 p-0 m-0">
                    <a href="" class="transaction-icon d-flex align-items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24"><rect width="24" height="24" fill="none"/><path fill="currentColor" d="M12 15.5A3.5 3.5 0 0 1 8.5 12A3.5 3.5 0 0 1 12 8.5a3.5 3.5 0 0 1 3.5 3.5a3.5 3.5 0 0 1-3.5 3.5m7.43-2.53c.04-.32.07-.64.07-.97c0-.33-.03-.66-.07-1l2.11-1.63c.19-.15.24-.42.12-.64l-2-3.46c-.12-.22-.39-.31-.61-.22l-2.49 1c-.52-.39-1.06-.73-1.69-.98l-.37-2.65A.506.506 0 0 0 14 2h-4c-.25 0-.46.18-.5.42l-.37 2.65c-.63.25-1.17.59-1.69.98l-2.49-1c-.22-.09-.49 0-.61.22l-2 3.46c-.13.22-.07.49.12.64L4.57 11c-.04.34-.07.67-.07 1c0 .33.03.65.07.97l-2.11 1.66c-.19.15-.25.42-.12.64l2 3.46c.12.22.39.3.61.22l2.49-1.01c.52.4 1.06.74 1.69.99l.37 2.65c.04.24.25.42.5.42h4c.25 0 .46-.18.5-.42l.37-2.65c.63-.26 1.17-.59 1.69-.99l2.49 1.01c.22.08.49 0 .61-.22l2-3.46c.12-.22.07-.49-.12-.64z"/></svg>
                        <span>Settings</span>
                    </a>
                </div>
            </div>
