<x-admin.layout>
    <x-slot name="bookjuniorhigh_list">
        <div class="container-fluid p-0 m-0">
            <div class="row row-cols-6 px-5 mt-5 m-0" style="min-width:1550px;">
                <div class="col p-2 m-0">
                    <div class="rounded shadow-lg bg-opacity-75 d-flex align-items-center px-4 justify-content-between" style="background-color:#333333;height:150px;width:100%;">
                        <div class="d-flex flex-column">
                            <h5 class="p-0 m-0 text-white fw-normal">Junior Higschool</h5>
