<x-admin.layout>
    <x-slot name="bookseniorhigh_list">
        <div class="container-fluid p-0 m-0">
            <div class="row row-cols-6 px-5 mt-5 m-0" style="min-width:1550px;">
                <div class="col p-2 m-0">
                    <div class="rounded shadow-lg bg-opacity-75 d-flex align-items-center px-4 justify-content-between" style="background-color:#001a33;height:150px;width:100%;">
                        <div class="d-flex flex-column">
                            <h5 class="p-0 m-0 text-white fw-normal">SeniorHighschool Higschool</h5>
                            <h6 class="p-0 m-0 fs-4 text-white fw-normal">{{ $seniorhigh }}</h6>
                        </div>
                    </div>
                </div>
                <div class="col mt-2">
                    <div class="rounded shadow-lg bg-opacity-75 d-flex align-items-center px-4 justify-content-between" style="background-color:#330033;height:150px;width:100%;">
                        <div class="d-flex flex-column">
                            <h5 class="p-0 m-0 text-white fw-normal">Available Books</h5>
                            <h6 class="p-0 m-0 fs-4 text-white fw-normal">{{ $bookAvailableCount }}</h6>
                        </div>
                    </div>
                </div>
                <div class="col p-2 m-0">
                ...
                <tbody>
                    ...
                    @foreach ($bookAvailable as $available)
                            <tr>
                                ...
                                <td class="text-success fw-bold align-middle">{{ $available->status }}</td>
