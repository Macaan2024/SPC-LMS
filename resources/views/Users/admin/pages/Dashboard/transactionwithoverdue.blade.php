<x-admin.layout>
    <x-slot name="transactionwithoverdue_list">
        <div class="container-fluid">
            <div class="d-flex gap-5 mt-5 justify-content-start" style="min-width:720px;">
                <div class="bg-opacity-50 rounded shadow-lg  d-flex align-items-center px-4 justify-content-between" style="background-color:#1a1a1a;width:250px;height:110px;min-width:220px;">
                    <div class="d-flex flex-column">
                        <small class="p-0 m-0 text-white">User Overdues</small>
            ...
            <form class="d-flex form-group mt-5 px-5" action="{{ route('admin.transactionwithoverdue.list')}}" method="GET">
                    ...
                    @foreach ($transactions as $approved )
                        <tr>
                            @if($approved->status == 'returned')
                                ...
                                <td class="align-middle fs-6"><a href="{{ route('admin.transaction-view', ['id' => $approved->id]) }}"><button style="height:32px;width:60px;" class="bg-primary text-white border-0 rounded">View</button></a></td>
                            @endif
                        </tr>
                    @endforeach
                </tbody>
