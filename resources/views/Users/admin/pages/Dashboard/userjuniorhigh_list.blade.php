<x-admin.layout>
    <x-slot name="userjuniorhigh_list">
    <div class="row row-cols-6 px-5 mt-5 m-0" style="min-width:1550px;">
        <div class="col p-2 m-0">
            <div class="rounded shadow-lg bg-opacity-75 d-flex align-items-center px-4 justify-content-between" style="background-color:#330000;height:150px;width:100%;">
                <div class="d-flex flex-column">
                    <h4 class="p-0 m-0 text-white fw-normal">Junior Highschool</h4>
    ...
    <div class="row m-0 p-0 mt-5 px-5" style="min-width:1550px;">
        <div class="col-6">
            <form class="d-flex form-group p-0m-0" action="{{ route('admin.userjuniorhigh.list')}}" method="GET">
