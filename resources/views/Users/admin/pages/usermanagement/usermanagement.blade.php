<x-admin.layout>
    <x-slot name="user_registration">
        <div class="row row-cols-6 px-5 mt-5 m-0" style="min-width:1550px;">
            ...
            <div class="col p-2 m-0">
                <div class="rounded shadow-lg bg-opacity-75 d-flex align-items-center px-4 justify-content-between" style="background-color:#660066;height:100%;width:100%;">
                    <div class="d-flex flex-column">
            ...
            <div class="col  p-2 m-0">
                <div class="rounded shadow-lg bg-opacity-75 d-flex align-items-center px-4 justify-content-between" style="background-color:#663500;height:100%;width:100%;">
                    <div class="d-flex flex-column">
