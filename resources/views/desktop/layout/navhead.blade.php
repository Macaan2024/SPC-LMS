...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-2 vh-100 bg-light d-flex flex-column justify-content-between">
                <div>
                    <div class="row px-3">
                        <div class="col-12 text-left mt-4 d-flex align-items-center">
                            <h6 class="p-0">MENU</h6>
                        </div>
                    </div>
                    <div class="border-bottom"></div>
                    <div class="dash-container row p-3">
                        <div class="col-12">
                    ...
                    <div class="book-icon-container row p-3">
                        <div class="col-12">
                    ...
                    <div class="inventory-icon-container row p-3">
                        <div class="col-12">
                            <a href="" class="inventory-icon d-flex align-items-center gap-2">
                    ...
                    <div class="account-icon-container row p-3">
                        <div class="col-12">
                            <a href="" class="account-icon d-flex align-items-center gap-2">
                    ...
                    <div class="user-icon-container row p-3">
                        <div class="col-12">
                            <a href="" class="user-icon d-flex align-items-center gap-2">
                    ...
                    <div class="transaction-icon-container row p-3">
                        <div class="col-12">
